...
public class TableHtmlActionTest {
	...
	public void testExecuteTimeFormat() throws Exception {
		...
		assertTrue(html.contains("<td class=\"name\">C</td><td class=\"type\">STOPWATCH</td><td class=\"counter\">1</td><td class=\"total\">300 ms</td><td class=\"min\">300 ms</td><td class=\"mean\">300 ms</td><td class=\"last\">300 ms</td><td class=\"max\">300 ms</td><td class=\"standardDeviation\">0</td>"));
