 ...
 * {@link org.javasimon.Manager#callback()} and {@link org.javasimon.callback.Callback#addCallback(Callback)}.
 * <p/>
 * Some callbacks are "simple" and do not support methods {@link org.javasimon.callback.Callback#addCallback(Callback)},
 * {@link org.javasimon.callback.Callback#removeCallback(Callback)} and {@link org.javasimon.callback.Callback#callbacks()} - these are
 * supported by "composite" callbacks.
 * <p/>
 * Simple callbacks are used to perform expected actions for particular events. {@link org.javasimon.callback.CallbackSkeleton}
 * can be extended if only selected events are desired to be implemented instead of implementating the whole {@link org.javasimon.callback.Callback}
 * interface.
 * <p/>
 ...
 * <ul>
 *     <li>{@link org.javasimon.callback.CompositeCallback} delegates all events to all sub-callbacks
